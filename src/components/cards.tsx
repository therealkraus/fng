...
export default function Cards() {
  return (
    <section
      id="creators"
      className="flex flex-col items-center justify-center ml-auto mr-auto sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl pr-10 pl-10 pt-10 pb-40"
    >
      ...
      <ul className="grid xl:grid-cols-3 xl:gap-6 2xl:grid-cols-4 2xl:gap-8 md:grid-cols-2 md:gap-6 grid-cols-1 gap-4">
        ...
        <Creators
          ...
          description={"Generates names for all your fantasy blacksmith needs!"}
        />
        <Creators
          title={"GENERAL SHOP"}
        ...
        <Creators
          ...
          description={"Generates names for all your fantasy magic shop needs!"}
        />
        <Creators
          title={"STABLES"}
